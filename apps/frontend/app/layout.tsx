...
export const metadata: Metadata = {
  title: 'CareerPilot-CN｜AI 求职助手',
  description: '面向中文工程与 AI 岗位的可解释匹配、简历定制和申请追踪工具',
  applicationName: 'CareerPilot-CN',
  keywords: ['AI 求职助手', '岗位匹配', '简历定制', 'job radar', 'resume matcher'],
};
